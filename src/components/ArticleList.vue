<template>
  <div class="col-xs-16 main">
    <div id="list-container">
      <ul class="note-list">
        <li class="have-img" v-for="article in articleList" v-bind:key="article.aId">
          <a class="wrap-img" href="" v-if="article.imageUrl">
            <img class="img-blur-done" src="article.imageUrl" alt="120">
          </a>
          <div class="content">
            <div class="author">
              <div class="info">
            ...
            <div class="meta">
              <a class="collection-tag" target="_blank" href="#">{{article.articleTypeName}}</a>
              <a target="_blank" href="#">
                <i class="iconfont ic-list-read"></i> {{article.pageview}}
              </a>
              <a target="_blank" href="#">
                <i class="iconfont ic-list-comments"></i> 273
              </a>
            </div>
          </div>
        </li>
...
export default {
  ...
  filters: {
    formatDate (time) {
      ...
      return formatDate(dtime, 'yyyy-MM-dd hh:mm')
    }
  },
  mounted () {
    this.getArticleData()
...
<style scoped>
  ...
  .index .aside .jianshu-daily .title, .index .aside .jianshu-daily .title a {
    font-size: 14px;
    color: #969696
  }
  ...
  .recommended-authors .list .follow-cancel i, .recommended-authors .list .follow-each i, .recommended-authors .list .follow i, .recommended-authors .list .following i {
    position: inherit;
    width: inherit;
    height: inherit;
    font-size: 13px
  ...
  .recommended-authors .list .follow-cancel, .recommended-authors .list .follow-each, .recommended-authors .list .following {
    color: #969696;
    border: none
  }

  .recommended-authors .list .follow-cancel:focus, .recommended-authors .list .follow-cancel:hover, .recommended-authors .list .follow-each:focus, .recommended-authors .list .follow-each:hover, .recommended-authors .list .following:focus, .recommended-authors .list .following:hover {
  ...
  .reader-night-mode .recommended-authors .list .name, .reader-night-mode .recommended-authors .page-change:hover {
    color: #c8c8c8
  }
  ...
  /*# sourceMappingURL=entry-937b76508b865b708ca2.css.map*/
</style>
